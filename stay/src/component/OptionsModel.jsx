        ...
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden">
            ...
            <div className="py-1">
                <Link
                    ...
                    onClick={onClose}
                >
                    <div className="w-10 h-10 rounded-lg bg-blue-200 flex items-center justify-center text-lg group-hover:bg-blue-300 transition">
                ...
                <Link
                    ...
                    onClick={onClose}
                >
                    <div className="w-10 h-10 rounded-lg bg-green-200  flex items-center justify-center group-hover:bg-green-300 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
            ...
            <div className="py-1">
                ...
                >
                    <div className="w-10 h-10 rounded-lg bg-amber-200 text-amber-600 flex items-center justify-center text-lg group-hover:bg-yellow-300 transition">
                        📦
                    </div>
                    <div className="flex-1">
            ...
            <div className="py-1">
                <button onClick={()=>{
                    ...
                    className="w-full flex items-center hover:bg-red-50 gap-3 px-4 py-3 transition group text-left"
                >
                    <div className="w-10 h-10 rounded-lg bg-red-300 text-red-600 flex items-center justify-center text-lg group-hover:bg-red-600 transition">
                    ...
                    <svg className="w-4 h-4 text-red-400 group-hover:text-red-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                </button>
            </div>
