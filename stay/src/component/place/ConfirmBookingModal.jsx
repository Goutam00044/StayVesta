...
export default function ConfirmBookingModal({
    ...
    return (
        <div className="fixed z-50 bg-black/50 min-h-screen w-screen flex justify-center items-center top-0 left-0">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 relative w-full max-w-sm mx-4">
                ...
                <p className="text-sm text-gray-500 mb-5">
                    Review or update your dates before continuing.
                </p>
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex-1 bg-amber-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-amber-500"
                    >
                        Confirm
                    </button>
